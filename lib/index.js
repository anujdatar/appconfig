...
function () {
  function AppConfig(options) {
    ...
    options = _objectSpread({}, options); // get project name from parent package
    ...
    this.configPath = _path["default"].resolve(options.configDir, "".concat(configName).concat(configExt)); // define store object
