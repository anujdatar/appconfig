...
var parentDir = _path["default"].dirname(module.parent && module.parent.filename || '.'); // parentDir = path.resolve(parentDir, '..')


console.log('conf parentDir', parentDir); // function to detect if variable is an object
...
function () {
  function AppConfig(options) {
    ...
    console.log('conf confPath', this.configPath); // define store object
  ...
  _createClass(AppConfig, [{
    ...
    value: function validate(data) {
      ...
      if (!valid) {
        var message = 'Config file data should be a dictionary object';
